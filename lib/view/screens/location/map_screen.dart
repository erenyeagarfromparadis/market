              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: widget.fromStore ? Text(
                    widget.address.address, style: cairoMedium,
                  ) : Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text(widget.address.addressType.tr, style: cairoRegular.copyWith(
                      ...
                      Text('- ${widget.address.contactPersonName}', style: cairoMedium.copyWith(
                        color: Theme.of(context).primaryColor,
                        fontSize: Dimensions.fontSizeLarge,
                      )),

                      Text('- ${widget.address.contactPersonNumber}', style: cairoRegular),
