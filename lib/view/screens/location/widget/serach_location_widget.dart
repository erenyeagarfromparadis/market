        ...
        child: Row(children: [
          ...
          Expanded(
            child: (pickedAddress != null && pickedAddress.isNotEmpty) ? Text(
              pickedAddress,
              style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeLarge), maxLines: 1, overflow: TextOverflow.ellipsis,
            ) : Text(
              hint ?? '',
              style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
