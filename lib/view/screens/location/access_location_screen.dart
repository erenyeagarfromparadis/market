          ...
          return (ResponsiveHelper.isDesktop(context) && locationController.getUserAddress() == null) ? WebLandingPage(
            ...
            child: FooterView(child: SizedBox( width: 700,
                child: Column(mainAxisAlignment: MainAxisAlignment.center,children: [
                  ...
                  Text('find_stores_and_items'.tr.toUpperCase(), textAlign: TextAlign.center, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
    ...
    return Center(child: SizedBox(width: 700, child: Column(children: [
      ...
      TextButton(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('set_from_map'.tr, textAlign: TextAlign.center, style: cairoBold.copyWith(
