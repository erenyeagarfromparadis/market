    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text('campaigns'.tr, style: cairoMedium.copyWith(fontSize: 24)),
        ),
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                ...
                                style: cairoBold.copyWith(fontSize: Dimensions.fontSizeSmall), textDirection: TextDirection.ltr,
