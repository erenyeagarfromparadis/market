    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(isPopular ? 'popular_items_nearby'.tr : 'best_reviewed_item'.tr, style: cairoMedium.copyWith(fontSize: 24)),
        ),
                        ...
                        Row(
                          children: [
                            Text(
                              ...
                              style: cairoBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                            ),
