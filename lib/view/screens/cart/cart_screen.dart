                      ...
                      child: SizedBox(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(PriceConverter.convertPrice(cartController.itemPrice), style: cairoRegular, textDirection: TextDirection.ltr),
                          ]),
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),

                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('discount'.tr, style: cairoRegular),
                            Text('(-) ${PriceConverter.convertPrice(cartController.itemDiscountPrice)}', style: cairoRegular, textDirection: TextDirection.ltr),
                          ]),
                          ...
                          Get.find<SplashController>().configModel.moduleConfig.module.addOn ? Row(
                            ...
                            children: [
                              ...
                              Text('(+) ${PriceConverter.convertPrice(cartController.addOns)}', style: cairoRegular, textDirection: TextDirection.ltr),
                            ],
                          ) : SizedBox(),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(PriceConverter.convertPrice(cartController.subTotal), style: cairoMedium, textDirection: TextDirection.ltr),
                            ],
                          ),
