        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center,
            ),
          ),
          ...
          GetBuilder<OrderController>(builder: (orderController) {
            return !orderController.isLoading ? Column(children: [
              ...
              TextButton(
                ...
                child: Text('cancel_order'.tr, textAlign: TextAlign.center, style: cairoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge.color)),
              ),
