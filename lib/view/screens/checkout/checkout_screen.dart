                    ...
                    child: FooterView(child: SizedBox(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        widget.storeId != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('your_prescription'.tr, style: cairoMedium),
                        ...
                        // Order type
                        Text('delivery_option'.tr, style: cairoMedium),
                        ...
                        orderController.orderType != 'take_away' ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('deliver_to'.tr, style: cairoMedium),
                            TextButton.icon(
                              onPressed: () async {
                              ...
                              label: Text('add'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            ),
                          ]),
                        ...
                        widget.storeId == null && storeController.store.scheduleOrder ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('preference_time'.tr, style: cairoMedium),
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          SizedBox(
                            height: 50,
                            child: ListView.builder(
                          ...
                          builder: (couponController) {
                            return Container(
                              ...
                              child: Column(children: [
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  Text('promo_code'.tr, style: cairoMedium),
                                  InkWell(
                                    onTap: () {
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(children: [
                                        Text('add_voucher'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
                                    ...
                                    Expanded(
                                      child: SizedBox(
                                        ...
                                        child: TextField(
                                          ...
                                          style: cairoRegular.copyWith(height: ResponsiveHelper.isMobile(context) ? null : 2),
                        ...
                        Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text('delivery_man_tips'.tr, style: cairoMedium),
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        ...
                        Text('choose_payment_method'.tr, style: cairoMedium),
                        SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        ...
                        widget.storeId == null && Get.find<SplashController>().configModel.moduleConfig.module.orderAttachment ? Column(
                          ...
                          children: [
                            Row(children: [
                              Text('prescription'.tr, style: cairoMedium),
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Text(
                                '(${'max_size_2_mb'.tr})',
                        ...
                        widget.storeId == null ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(_module.addOn ? 'subtotal'.tr : 'item_price'.tr, style: cairoMedium),
                        ...
                        (couponController.discount > 0 || couponController.freeDelivery) ? Column(children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            (couponController.coupon != null && couponController.coupon.couponType == 'free_delivery') ? Text(
                              'free_delivery'.tr, style: cairoRegular.copyWith(color: Theme.of(context).primaryColor),
                            ) : Text(
                        ...
                        widget.storeId == null ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('vat_tax'.tr + ' ${_taxIncluded ? 'tax_included'.tr : ''}', style: cairoRegular),
                          Text('${_taxIncluded ? '' : '(+) '}' + PriceConverter.convertPrice(_tax), style: cairoRegular, textDirection: TextDirection.ltr),
                        ]) : SizedBox(),
                        SizedBox(height: widget.storeId == null ? Dimensions.PADDING_SIZE_SMALL : 0),
                        ...
                        (widget.storeId == null && Get.find<SplashController>().configModel.dmTipsStatus == 1) ? Row(
                          ...
                          children: [
                            ...
                            Text('(+) ${PriceConverter.convertPrice(orderController.tips)}', style: cairoRegular, textDirection: TextDirection.ltr),
                          ],
                        ) : SizedBox.shrink(),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          _deliveryCharge == -1 ? Text(
                            'calculating'.tr, style: cairoRegular.copyWith(color: Colors.red),
                          ) : (_deliveryCharge == 0 || (couponController.coupon != null && couponController.coupon.couponType == 'free_delivery')) ? Text(
                            'free'.tr, style: cairoRegular.copyWith(color: Theme.of(context).primaryColor),
                          ) : Text(
