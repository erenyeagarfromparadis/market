        ...
        children: [
          ...
          Container(
            ...
            child: RichText(text: TextSpan(children: [
              ...
              TextSpan(text: ' ${'30'}', style: cairoMedium.copyWith(
                  fontSize:Dimensions.PADDING_SIZE_DEFAULT,
                  color: Theme.of(context).primaryColor)),
              TextSpan(text: 'minutes'.tr, style: cairoMedium.copyWith(
                  fontSize:Dimensions.PADDING_SIZE_DEFAULT,
                  color: Theme.of(context).primaryColor)),
              TextSpan(text: 'max'.tr, style: cairoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge.color)),
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('${vehicle.name}',style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                      ...
                      Row(
                        children: [
                          ...
                          Text(vehicle.brandName, style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),)
                        ],
                      ),
                      SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                      ...
                      Row(
                        children: [
                          ...
                          Text(' ${vehicle.modelName}',style:  cairoBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall),),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          TextButton.icon(
                            ...
                            label: Text(
                              'call_now'.tr,
                              style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor, decoration: TextDecoration.underline),
                            ),
                          ),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(filterBody.filterType == 'hourly' ? 'hourly'.tr : 'per_km'.tr, style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                        ],
                      )
                    ],
                  ),
