            ...
            child: SingleChildScrollView(
              ...
              child: FooterView(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _isLoggedIn ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('saved_address'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                              Text(locationController.addressList[index].addressType, style: cairoMedium),
                  ...
                  Row(
                    ...
                    children: [
                      Text('trip_history'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                      InkWell(
                        onTap: (){},
                        child: Text('view_all'.tr, style: cairoBold.copyWith(
                          color: Theme.of(context).primaryColor,
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                              Text('Dhanmondi to Mirpur DOHS ', style: cairoMedium),
                              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Text(
