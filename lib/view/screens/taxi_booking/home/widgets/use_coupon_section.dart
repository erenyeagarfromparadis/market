        ...
        child: Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Text('use_coupon_when_select_your_car'.tr,style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall),),
                Text('collect_coupon_by_inviting_people'.tr,style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),),
              ],
            ),
