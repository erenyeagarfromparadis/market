    ...
    return Column(
      children: [
        ...
        Align(
            ...
            child: Text('add_address'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault))),
        SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
              ...
              children: [
                Row(children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('add_address'.tr,style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall),),
                      Text('type_or_select_from_map'.tr,style: cairoRegular.copyWith(fontSize: 10),),
                    ],
                  ),
                ],),
                Padding(
