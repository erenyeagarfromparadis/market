          ...
          child: Column(
            children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('Range Rover-2020',style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault),),
                          Row(
                            children: [
                              Image.asset(Images.demo_brand_car),
                              Text("ABC rent a car",style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),)
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Text('B 45 55 23',style:  cairoBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall),),
                            ],
                          ),
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL,),
                          Text(
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text('Tuesday, 16 Auust 2022, 10.45 am',style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault),),
                          Image.asset(
                            Images.edit,
                            width: 16,
                            height: 16,),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text('hourly'.tr,style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                            ],
                          )
                        ],
                      ),
              ...
              Stack(
                children: [
                  Container(
                    child: Center(child: Text('cancel_booking'.tr,style: cairoRegular.copyWith(color: Theme.of(context).cardColor),)),
                    width: 175,
                    height: 45,
                    decoration: BoxDecoration(
