...
class ProviderDetails extends StatelessWidget {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('provider_details'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
  ...
  Widget _providerDetailsItem(String title,String subTitle,){
    return Row(
      ...
      children: [
        Text(title,style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeDefault),),
        Text(subTitle,style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeDefault),),
      ],
    );
