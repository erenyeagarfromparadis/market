                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('the_car_will_arrived_within'.tr,style: cairoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                        color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5),
                      ),),
                      SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT,),

                      Text("15 - 20 mins",style: cairoMedium.copyWith(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text("2.2 km away",style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeDefault),)
                        ],
                      ),
                      SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT,),
                      ...
                      Align(
                          ...
                          child: Text('car_driver'.tr,style: cairoRegular.copyWith(fontSize: Dimensions.PADDING_SIZE_SMALL),)),
                      SizedBox(height: Dimensions.PADDING_SIZE_SMALL,),
                      Row(
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text("Alex Maxwell",style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault),),
                                  Row(
                                    children: [
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: Dimensions.PADDING_SIZE_SMALL,),
                                  Text('chat'.tr,style: cairoRegular.copyWith(
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: Dimensions.PADDING_SIZE_SMALL,),
                                  Text('call'.tr,style: cairoRegular.copyWith(
                                      color: Theme.of(context).primaryColor,
                                      fontSize: Dimensions.fontSizeSmall,
                                    decoration: TextDecoration.underline,
                                  ),)
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: Dimensions.PADDING_SIZE_SMALL,),
                              Text("RAnge Rover-2020",style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault),),
                            ],
                          ),
                          Row(
                            children: [
                              Text('car_no'.tr,style: cairoRegular.copyWith(
                                  color: Theme.of(context).primaryColor,
                                  fontSize: Dimensions.fontSizeSmall
                              ),),
                              SizedBox(width: Dimensions.PADDING_SIZE_SMALL,),

                              Text('B 45 55 23'.tr,style: cairoMedium.copyWith(
                                  color: Theme.of(context).textTheme.bodyLarge.color,
                                  fontSize: Dimensions.fontSizeSmall
                              ),),
                            ],
