                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('trip_info'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeSmall),),
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('date'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                  Text(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('time'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                  Text(
