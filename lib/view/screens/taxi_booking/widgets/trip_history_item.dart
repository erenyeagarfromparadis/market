    ...
    return Container(
      ...
      child: Column(
        ...
        Row(
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Text('${ 'order_id'.tr}:', style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),

                Text('#${trip.id}', style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
              ]),
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Text(trip.deliveryAddress?? '', style: cairoMedium.copyWith(
                              fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.7)),
                          ),
                          SizedBox(height: 12),
                          Text("Dhanmondi 32",style: cairoMedium.copyWith(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            Text(PriceConverter.convertPrice(trip.trip.estimatedFare), style: cairoMedium.copyWith(
              fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).textTheme.bodyLarge.color,
            )),
            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),

            Text(trip.trip.tripStatus, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor)),
          ]),
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('view_details'.tr,style: cairoRegular.copyWith(
            ...
            Row(
              children: [
                TextButton(
                  ...
                  child: Text('give_review'.tr, style: cairoRegular.copyWith(
