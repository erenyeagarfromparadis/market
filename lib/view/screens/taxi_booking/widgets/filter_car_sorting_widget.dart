    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Row(
          ...
          children: [
            Text(title, style: carSelectionController.sortByIndex == value ? cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault) : cairoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
