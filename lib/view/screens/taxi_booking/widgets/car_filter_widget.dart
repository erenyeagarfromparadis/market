          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT,),
                Text("filter_by".tr,style: cairoRegular.copyWith(
                ...
                Align(
                    ...
                    child: Text('price_range'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeSmall),)),
                SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT,),
                Container(
                  decoration: BoxDecoration(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(text: '${Get.find<SplashController>().configModel.currencySymbol}', style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                              TextSpan(
                                  text: carSelectionController.startingPrice.toString(),
                                  style: cairoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraLarge),
                              ),
                              TextSpan(
                                  text: '/hr',
                                  style: cairoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5), fontSize: Dimensions.fontSizeSmall),
                              ),
                            ],
                          ),
                        ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    Text('basic'.tr, style: cairoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5))),
                    Container(height: 10, width: 1, color: Theme.of(context).primaryColor),

                    Text('standard'.tr, style: cairoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5))),
                    Container(height: 10, width: 1, color: Theme.of(context).primaryColor),

                    Text('premium'.tr, style: cairoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5)),
                    ),
                  ],
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                ...
                Align(
                    alignment: Alignment.centerLeft,
                    child: Text('model'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeSmall))),
                SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                ...
                // Align(
                //     alignment: Alignment.centerLeft,
                //     child: Text('car_type'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeSmall),)),
                // SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT,),
                // Container(
                //   height: 50,
                //   child: ListView.builder(
                ...
                Align(
                    alignment: Alignment.centerLeft,
                    child: Text('sort_by'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                ),
