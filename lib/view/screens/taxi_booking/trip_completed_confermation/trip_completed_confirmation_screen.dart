        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('trip_completed'.tr,style: cairoBold.copyWith(
              ...
              Text('your_trip_has_been_complete'.tr,textAlign: TextAlign.center,style: cairoRegular.copyWith(
                  color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5),
                  fontSize: Dimensions.fontSizeDefault,
              ),),

              SizedBox(height: 40,),
              Text('how_was_your_service'.tr,style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).primaryColor),),
              SizedBox(height: 4),
              Text('give_us_your_valuable_review'.tr,style: cairoRegular.copyWith(
                  color: Theme.of(context).textTheme.bodyLarge.color.withOpacity(.5),
              ...
              TextButton(
                  onPressed: (){},
                  child: Text('not_now'.tr,style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault),))
