...
class DetailsAppBarState extends State<DetailsAppBar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      title: Text(
        'item_details'.tr,
        style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge.color),
      ),
      centerTitle: true,
                ...
                child: Container(
                  ...
                  child: GetBuilder<CartController>(builder: (cartController) {
                    return Text(
                      ...
                      style: cairoMedium.copyWith(color: Colors.white, fontSize: 8),
                    );
                  }),
                ),
              ),
