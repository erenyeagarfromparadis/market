    ...
    return ResponsiveHelper.isDesktop(context) ? GetBuilder<ItemController>(builder: (itemController){
      return Column(
        ...
        children: [
          Text(
            item.name ?? '',
            style: cairoMedium.copyWith(fontSize: 30),
          ...
          Row(children: [
            Text(
              ...
              style: cairoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: 30), textDirection: TextDirection.ltr,
            ),
            ...
            item.discount > 0 ? Flexible(
              child: Text(
                ...
                style: cairoRegular.copyWith(color: Colors.red, decoration: TextDecoration.lineThrough,fontSize: Dimensions.fontSizeLarge),
              ),
            ) : SizedBox(),
            ...
            Container(
              ...
              child: Text(inStock ? 'out_of_stock'.tr : 'in_stock'.tr, style: cairoRegular.copyWith(
                color: Colors.white,
        ...
        builder: (itemController) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Expanded(child: Text(
                item.name ?? '',
                style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge),
                maxLines: 2, overflow: TextOverflow.ellipsis,
              )),
                  ...
                  builder: (wishController) {
                    return Row(
                      children: [
                        ...
                        //   style: cairoMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE),
                        // ),
                        // SizedBox(width: 5),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  '${PriceConverter.convertPrice(_startingPrice, discount: item.discount, discountType: item.discountType)}'
                      '${_endingPrice!= null ? ' - ${PriceConverter.convertPrice(_endingPrice, discount: item.discount, discountType: item.discountType)}' : ''}',
                  style: cairoMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
                ),
                SizedBox(height: 5),
                ...
                !isCampaign ? Row(children: [
                  Text(item.avgRating.toStringAsFixed(1), style: cairoRegular.copyWith(
