            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(itemController.item.choiceOptions[index].title, style:cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  ...
                  // Quantity
                  Row(children: [
                    Text('quantity'.tr, style:cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  ...
                  GetBuilder<CartController>(builder: (cartController) {
                    return Row(children: [
                      Text('${'total_amount'.tr}:', style:cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ...
                      Text(PriceConverter.convertPrice(itemController.cartIndex != -1 ? (cartController.cartList[itemController.cartIndex].discountedPrice * cartController.cartList[itemController.cartIndex].quantity)
                          : _priceWithAddons ?? 0.0), textDirection: TextDirection.ltr, style:cairoBold.copyWith(
                  ...
                  (itemController.item.description != null && itemController.item.description.isNotEmpty) ? Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                      Text(itemController.item.description, style: cairoRegular),
                      SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                    ],
                  ) : SizedBox(),
                ],
