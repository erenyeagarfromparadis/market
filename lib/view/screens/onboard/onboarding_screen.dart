              ...
              itemBuilder: (context, index) {
                return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(
                    ...
                    style: cairoMedium.copyWith(fontSize: context.height*0.022),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: cairoRegular.copyWith(fontSize: context.height*0.015, color: Theme.of(context).disabledColor),
                      textAlign: TextAlign.center,
                    ),
                  ),
