                                  ...
                                  Container(
                                    ...
                                    child:  Row(mainAxisAlignment: widget.fromWallet ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                                      ...
                                      widget.fromWallet ? Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                                          children: [
                                            Text('wallet_amount'.tr,style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                                          ...
                                          : Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.end, children: [
                                            ...
                                            Text(
                                              ...
                                              style: cairoBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).textTheme.bodyLarge.color),
                                            ),
                                            Text(
                                              'loyalty_points'.tr + ' !',
                                              style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge.color),
                                            ),
                                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                                      ])
                                    ]),
                                  ...
                                  widget.fromWallet ? SizedBox.shrink() : Positioned(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            'convert_to_currency'.tr , style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,
