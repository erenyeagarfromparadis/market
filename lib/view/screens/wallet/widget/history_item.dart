        ...
        children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            fromWallet ? Text(data[index].transactionType == 'order_place'
              ...
              style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.ltr,
            ) : Row(children: [
              Text(data[index].transactionType == 'point_to_wallet'? data[index].debit.toStringAsFixed(0)
                  : data[index].credit.toStringAsFixed(0),
                  style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis),
              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),

              Text('points'.tr, style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).disabledColor),
              )]),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            Text(DateConverter.dateToDateAndTimeAm(data[index].createdAt),style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).disabledColor),
                maxLines: 1, overflow: TextOverflow.ellipsis),
            SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
            ...
            Text( fromWallet ? data[index].transactionType == 'order_place' ? 'debit'.tr : 'credit'.tr : data[index].transactionType == 'point_to_wallet' ? 'debit'.tr : 'credit'.tr,
                style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: fromWallet ? data[index].transactionType == 'order_place'
