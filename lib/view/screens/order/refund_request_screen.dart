                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('what_is_wrong_with_this_order'.tr, style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                        ...
                        orderController.selectedReasonIndex != 0 ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('additional_note'.tr, style: cairoMedium),
                          SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                                ...
                                child: orderController.refundImage != null ? GetPlatform.isWeb ? Image.network(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                      ...
                                      Text('upload_image'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).disabledColor)),
                                    ]),
                                  ),
                                ),
                              ),
