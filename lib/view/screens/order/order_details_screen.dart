          ...
          return orderController.orderDetails != null && _order != null ? Column(children: [
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: FooterView(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Text('${_parcel ? 'delivery_id'.tr : 'order_id'.tr}:', style: cairoRegular),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(_order.id.toString(), style: cairoMedium),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                ...
                _order.scheduled == 1 ? Row(children: [
                  ...
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(DateConverter.dateTimeStringToDateTime(_order.scheduleAt), style: cairoMedium),
                ]) : SizedBox(),
                ...
                Get.find<SplashController>().configModel.orderDeliveryVerification ? Row(children: [
                  Text('${'delivery_verification_code'.tr}:', style: cairoRegular),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(_order.otp, style: cairoMedium),
                ]) : SizedBox(),
                SizedBox(height: Get.find<SplashController>().configModel.orderDeliveryVerification ? 10 : 0),

                Row(children: [
                  Text(_order.orderType.tr, style: cairoMedium),
                  Expanded(child: SizedBox()),
                  Container(
                ...
                Padding(
                  ...
                  child: Row(children: [
                    Text('${_parcel ? 'charge_pay_by'.tr : 'item'.tr}:', style: cairoRegular),
                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                    Text(
                ...
                _order.orderStatus == 'canceled' ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Divider(height: Dimensions.PADDING_SIZE_LARGE),
                  Text('${'cancellation_note'.tr}:', style: cairoMedium),
                  SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                ...
                (_order.orderStatus == 'refund_requested' || _order.orderStatus == 'refund_request_canceled') ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  _order.orderStatus == 'refund_requested' ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    RichText(text: TextSpan(children: [
                      TextSpan(text: '${'refund_note'.tr}:', style: cairoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge.color)),
                      TextSpan(text: '(${(_order.refund != null) ? _order.refund.customerReason : ''})', style: cairoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge.color)),
                    ])),
                    SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                    ...
                    Text('${'refund_cancellation_note'.tr}:', style: cairoMedium),
                    SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                ...
                CardWidget(showCard: _parcel, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(_parcel ? 'parcel_category'.tr : Get.find<SplashController>().getModuleConfig(_order.moduleType).showRestaurantText
                      ? 'restaurant_details'.tr : 'store_details'.tr, style: cairoRegular),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  (_parcel && _order.parcelCategory == null) ? Text(
                    'no_parcel_category_data_found'.tr, style: cairoMedium
                    ...
                    && (_parcel || (orderController.orderDetails.isNotEmpty && orderController.orderDetails[0].itemCampaignId == null))) ? InkWell(
                      ...
                      child: Container(
                        ...
                        child: Text('refund_this_order'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
                      ),
                    ) : SizedBox(),
                ...
                _parcel ? SizedBox() : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text(PriceConverter.convertPrice(_itemsPrice), style: cairoRegular, textDirection: TextDirection.ltr),
                  ]),
                  SizedBox(height: 10),
                  ...
                  Get.find<SplashController>().getModuleConfig(_order.moduleType).addOn ? Row(
                    ...
                    children: [
                      ...
                      Text('(+) ${PriceConverter.convertPrice(_addOns)}', style: cairoRegular, textDirection: TextDirection.ltr),
                    ],
                  ) : SizedBox(),
                  ...
                  Get.find<SplashController>().getModuleConfig(_order.moduleType).addOn ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('subtotal'.tr+ ' ${_taxIncluded ? 'tax_included'.tr : ''}', style: cairoMedium),
                      Text(PriceConverter.convertPrice(_subTotal), style: cairoMedium, textDirection: TextDirection.ltr),
                    ],
                  ) : SizedBox(),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text('(-) ${PriceConverter.convertPrice(_discount)}', style: cairoRegular, textDirection: TextDirection.ltr),
                  ]),
                  SizedBox(height: 10),
                  ...
                  _couponDiscount > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text(
                      ...
                      style: cairoRegular, textDirection: TextDirection.ltr,
                    ),
                  ]) : SizedBox(),
                  ...
                  !_taxIncluded ?  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text('(+) ${PriceConverter.convertPrice(_tax)}', style: cairoRegular, textDirection: TextDirection.ltr),
                  ]) : SizedBox(),
                  ...
                  (_dmTips > 0) ? Row(
                    ...
                    children: [
                      ...
                      Text('(+) ${PriceConverter.convertPrice(_dmTips)}', style: cairoRegular, textDirection: TextDirection.ltr),
                    ],
                  ) : SizedBox(),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    _deliveryCharge > 0 ? Text(
                      '(+) ${PriceConverter.convertPrice(_deliveryCharge)}', style: cairoRegular, textDirection: TextDirection.ltr,
                    ) : Text('free'.tr, style: cairoRegular.copyWith(color: Theme.of(context).primaryColor)),
                  ]),
                ]),
    ...
    return Column(children: [
      !orderController.showCancelled ? Center(
          ...
          child: Row(children: [
            ...
            order.orderStatus == 'pending' ? Expanded(child: Padding(
              ...
              child: TextButton(
                ...
                child: Text(parcel ? 'cancel_delivery'.tr : 'cancel_order'.tr, style: cairoBold.copyWith(
        ...
        child: Container(
          ...
          child: Text('order_cancelled'.tr, style: cairoMedium.copyWith(color: Theme.of(context).primaryColor)),
        ),
      ),
