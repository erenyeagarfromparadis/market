                            ...
                            Row(children: [
                              ...
                              Stack(children: [
                                ...
                                _isParcel ? Positioned(left: 0, top: 10, child: Container(
                                  ...
                                  child: Text('parcel'.tr, style: cairoMedium.copyWith(
                                ...
                                _isPrescription ? Positioned(left: 0, top: 10, child: Container(
                                  ...
                                  child: Text('prescription'.tr, style: cairoMedium.copyWith(
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Row(children: [
                                    ...
                                    Text('#${paginatedOrderModel.orders[index].id}', style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                  ]),
                              ...
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Container(
                                  ...
                                  child: Text(paginatedOrderModel.orders[index].orderStatus.tr, style: cairoMedium.copyWith(
                                ...
                                isRunning ? InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(children: [
                                      ...
                                      SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                      Text(_isParcel ? 'track_delivery'.tr : 'track_order'.tr, style: cairoMedium.copyWith(
                                        fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor,
                                      )),
                                    ]),
                                  ),
