  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!_takeAway && track.deliveryMan == null) ? Padding(
        padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
        child: Text(
          'delivery_man_not_assigned'.tr, style: cairoMedium, textAlign: TextAlign.center,
        ),
      ) : Column(children: [

        Text('trip_route'.tr, style: cairoMedium),
        ...
        Row(children: [
          ...
          Expanded(
            flex: 5,
            child: (_takeAway && track.orderType != 'parcel') ? Text(track.store != null ? track.store.address : '', style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
