                ...
                Row(
                  children: [
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        Text(widget.orderDetailsList[index].itemDetails.name, style: cairoMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                        SizedBox(height: 10),
                        Text(PriceConverter.convertPrice(widget.orderDetailsList[index].itemDetails.price), style: cairoBold, textDirection: TextDirection.ltr),
                      ],
                    )),
                    Row(children: [
                      Text(
                        '${'quantity'.tr}: ',
                        style: cairoMedium.copyWith(color: Theme.of(context).disabledColor), overflow: TextOverflow.ellipsis,
                      ),
                      Text(
