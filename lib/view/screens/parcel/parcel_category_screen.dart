        ...
        return Stack(clipBehavior: Clip.none, children: [
          ...
          SingleChildScrollView(
            ...
            child: FooterView(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Center(child: Text('instant_same_day_delivery'.tr, style: cairoMedium)),
              Center(child: Text(
                'send_things_to_your_destination_instantly_and_safely'.tr,
                style: cairoRegular, textAlign: TextAlign.center,
              )),
              SizedBox(height: Dimensions.PADDING_SIZE_LARGE),

              Text('what_are_you_sending'.tr, style: cairoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                          Text(parcelController.parcelCategoryList[index].name, style: cairoMedium),
                          SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          Text(
