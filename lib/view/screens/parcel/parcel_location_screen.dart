                      ...
                      tabs: [
                        Padding(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('sender'.tr, style: cairoMedium.copyWith(color: parcelController.isSender ? Theme.of(context).cardColor : Theme.of(context).disabledColor),)
                          ]),
                        ),
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Image.asset(Images.sender, color: !parcelController.isSender ? Theme.of(context).cardColor : Theme.of(context).disabledColor, width: 40, fit: BoxFit.fitWidth),
                          SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          Text('receiver'.tr, style: cairoMedium.copyWith(color: !parcelController.isSender ? Theme.of(context).cardColor : Theme.of(context).disabledColor),)
                        ]),
                      ],
                    ),
