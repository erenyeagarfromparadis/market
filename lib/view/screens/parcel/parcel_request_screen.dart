            ...
            child: FooterView(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              CardWidget(child: Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(widget.parcelCategory.name, style: cairoMedium.copyWith(color: Theme.of(context).primaryColor)),
                  Text(
              ...
              CardWidget(child: Row(children: [
                Expanded(child: Row(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('distance'.tr, style: cairoRegular),
                    Text(
              ...
              Text('charge_pay_by'.tr, style: cairoMedium),
              ...
              Row(children: [
                Expanded(child: InkWell(
                  ...
                  child: Row(children: [
                    ...
                    Text(parcelController.payerTypes[0].tr, style: cairoRegular),
                  ]),
                )),
                _isCashOnDeliveryActive ? Expanded(child: InkWell(
                  ...
                  child: Row(children: [
                    ...
                    Text(parcelController.payerTypes[1].tr, style: cairoRegular),
                  ]),
                )) : SizedBox(),
              ]),
              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
