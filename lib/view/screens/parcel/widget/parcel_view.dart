            ...
            child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Padding(
              ...
              child: Column(children: [
                  ...
                  Expanded(flex: 6,
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text('set_from_saved_address'.tr, style: cairoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge))),
                        ),
                      )
                  ),
                ]),
                ...
                Column(children: [
                  ...
                  Center(child: Text(parcelController.isSender ? 'sender_information'.tr : 'receiver_information'.tr, style: cairoMedium)),
                ...
                Column(children: [
                  ...
                  Center(child: Text(parcelController.isSender ? 'pickup_information'.tr : 'destination_information'.tr, style: cairoMedium)),
                  SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
