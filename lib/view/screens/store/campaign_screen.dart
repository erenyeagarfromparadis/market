            ...
            ResponsiveHelper.isDesktop(context) ? SliverToBoxAdapter(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: Text(
                  ...
                  style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white),
                ),
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(
                          campaignController.campaign.title, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ...
                    campaignController.campaign.startTime != null ? Row(children: [
                      Text('campaign_schedule'.tr, style: cairoRegular.copyWith(
