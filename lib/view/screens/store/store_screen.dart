              ...
              SliverToBoxAdapter(child: Center(child: Container(
                ...
                child: Column(children: [
                  ...
                  _store.discount != null ? Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text(
                        ...
                        style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).cardColor),
                      ...
                      Text(
                        ...
                        style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor), textDirection: TextDirection.ltr,
                      ),
                      ...
                      _store.discount.minPurchase != 0 ? Text(
                        ...
                        style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor), textDirection: TextDirection.ltr,
                      ) : SizedBox(),
                      ...
                      Text(
                        ...
                        style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor),
                      ),
                    ]),
                  ) : SizedBox(),
                  ...
                  storeController.recommendedItemModel != null && storeController.recommendedItemModel.items.length > 0 ? Column(
                    ...
                    children: [
                      Text('recommended_items'.tr, style: cairoMedium),
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Text(
                              ...
                              style: index == storeController.categoryIndex
                                  ? cairoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)
                                  : cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                            ),
              ...
              AnimatedContainer(
                ...
                child: storeController.currentState ? Center(
                  child: Text(
                    ...
                    style: cairoMedium.copyWith(color: Theme.of(context).cardColor), maxLines: 1, overflow: TextOverflow.ellipsis,
                  ),
                ) : SizedBox(),
              ),
