              ...
              child: Container(
                ...
                child: GetBuilder<AuthController>(builder: (authController) {
                  ...
                  return Column(children: [
                    ...
                    // Center(child: Text(AppConstants.APP_NAME, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge))),
                    SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_LARGE),

                    Text('sign_up'.tr.toUpperCase(), style: cairoBlack.copyWith(fontSize: 30)),
                    SizedBox(height: 50),
...
//    حذف الايميلString _email = _emailController.text.trim();
