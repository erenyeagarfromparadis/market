          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('filter'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                CustomButton(
                  onPressed: () {
              ...
              Text('sort_by'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ...
              Text('filter_by'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
              ...
              isStore ? SizedBox() : Column(children: [
                Text('price'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                RangeSlider(
              ...
              Text('rating'.tr, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              Container(
