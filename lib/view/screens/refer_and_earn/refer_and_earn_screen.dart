              ...
              child: Padding(
                ...
                child: GetBuilder<UserController>(builder: (userController) {
                    return Column( children: [
                      ...
                      Text('earn_money_on_every_referral'.tr, style: cairoRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall)),
                      ...
                      Text(
                          ...
                          style: cairoBold.copyWith(fontSize: Dimensions.fontSizeDefault), textDirection: TextDirection.ltr,
                      ),
                      SizedBox(height: 40),
                      ...
                      Center(
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          Column(children: [
                            ...
                            SizedBox(width: 120,
                                child: Text('refer_your_code_to_your_friend'.tr , style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center),
                            ),
                          ]),
                          ...
                          Column(children: [
                            ...
                            SizedBox(width: 120, child: Text(
                                'get'.tr + ' ${PriceConverter.convertPrice(Get.find<SplashController>().configModel != null ? Get.find<SplashController>().configModel.refEarningExchangeRate.toDouble() : 0.0)} ' +
                                    'on_joining'.tr , style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center, textDirection: TextDirection.ltr),
                            ),
                          ]),
                        ]),
                      ),
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('your_referral_code'.tr, style: cairoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeDefault)),
                            ...
                            child: (userController.userInfoModel != null) ? Row(children: [
                              Expanded(
                                child: Text(
                                  ...
                                  style: cairoBlack.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraLarge),
                                ),
                              ),
                              InkWell(
                                onTap: () {
                                ...
                                child: Text('tap_to_copy'.tr, style: cairoMedium),
                              ),
