            ...
            _languageList.add(DropdownMenuItem(
              child: TextHover(builder: (hovered) {
                return Row(children: [
                  ...
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(AppConstants.languages[index].languageName, style: cairoRegular.copyWith(color: hovered ? Theme.of(context).primaryColor : null)),
                ]);
              }),
              value: index,
            ));
          ...
          return InkWell(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Text(authController.isLoggedIn() ? 'profile'.tr : 'sign_in'.tr, style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white)),
              ]),
            ),
          );
        }),
...
class MenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        onTap: onTap,
        child: Text(title, style: cairoRegular.copyWith(color: hovered ? Theme.of(context).primaryColor : null)),
      );
    });
  }
}
            ...
            (isCart && cartController.cartList.length > 0) ? Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: cairoRegular.copyWith(fontSize: 12, color: Theme.of(context).cardColor),
                ),
              ),
            ) : SizedBox()
          ]);
