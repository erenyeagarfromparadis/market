...
void showCartSnackBar(BuildContext context) {
  ScaffoldMessenger.of(Get.context).showSnackBar(SnackBar(
    ...
    content: Text('item_added_to_cart'.tr, style: cairoMedium.copyWith(color: Colors.white)),
  ...
  //     child: Text('view_cart'.tr, style: cairoMedium.copyWith(color: Theme.of(context).cardColor)),
  //   ),
