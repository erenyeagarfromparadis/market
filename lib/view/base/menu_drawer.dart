        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text('menu'.tr, style: cairoBold.copyWith(fontSize: 20, color: Colors.white)),
            ),
                  ...
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Text(_menuList[index].title, style: cairoMedium, overflow: TextOverflow.ellipsis, maxLines: 1)),
