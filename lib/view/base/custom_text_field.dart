  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        widget.showTitle ? Text(widget.hintText, style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : SizedBox(),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: cairoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
            filled: true,
