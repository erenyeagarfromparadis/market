              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(
                        widget.item.name, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                      ...
                      Text(
                        ...
                        style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
                      ),
                  ...
                  Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    || (Get.find<SplashController>().configModel.moduleConfig.module.vegNonVeg && Get.find<SplashController>().configModel.toggleVegNonVeg)) ? Container(
                      ...
                      child: Text(
                        ...
                        style: cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white),
                      ),
                    ) : SizedBox(),
                ...
                (widget.item.description != null && widget.item.description.isNotEmpty) ? Column(
                  ...
                  children: [
                    ...
                    Text(widget.item.description, style: cairoRegular),
                    SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                  ],
                ) : SizedBox(),
                ...
                Row(children: [
                  ...
                  Row(children: [
                    ...
                    Text(itemController.quantity.toString(), style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    QuantityButton(
                ...
                Row(children: [
                  ...
                  Text(
                    ...
                    style: cairoBold.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                  ),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  _discount > 0 ? Text(
                    PriceConverter.convertPrice(
                    ...
                    style: cairoMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                  ) : SizedBox(),
                ]),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
      ...
      itemBuilder: (context, index) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
            Text(item.foodVariations[index].name, style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
          ...
          Row(children: [
            (item.foodVariations[index].multiSelect) ? Text(
              ...
              style: cairoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
            ) : SizedBox(),
          ]),
                ...
                child: Row(children: [
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Text(
                      ...
                      maxLines: 1, overflow: TextOverflow.ellipsis,
                      style: itemController.selectedVariations[index][i] ? cairoMedium : cairoRegular,
                    ),
                  ...
                  Text(
                    ...
                    style: itemController.selectedVariations[index][i] ? cairoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)
                        : cairoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                  ),
