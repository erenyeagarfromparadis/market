    ...
    return Column(children: [
      ...
      (widget.visibility && ResponsiveHelper.isDesktop(context)) ? Container(
        ...
        child: Center(child: Column(children: [
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(flex: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  Text(
                    ...
                    style: cairoBold.copyWith(fontSize: 40, color: _color),
                  ),
                ]),
                const SizedBox(height: Dimensions.PADDING_SIZE_LARGE),

                Text('news_letter'.tr, style: cairoBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),

                Text('subscribe_to_out_new_channel_to_get_latest_updates'.tr, style: cairoRegular.copyWith(color: _color, fontSize: Dimensions.fontSizeExtraSmall)),
                const SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: TextField(
                      ...
                      style: cairoMedium.copyWith(color: Colors.black),
                      decoration: InputDecoration(
                        hintText: 'your_email_address'.tr,
                        hintStyle: cairoRegular.copyWith(color: Colors.grey,fontSize: Dimensions.fontSizeSmall),
                    ...
                    GetBuilder<SplashController>(builder: (splashController) {
                      return !splashController.isLoading ? InkWell(
                        ...
                        child: Container(
                          ...
                          child: Text('subscribe'.tr, style: cairoRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeSmall)),
                        ),
              ...
              Expanded(flex: 4, child: Column(children: [
                ...
                (_config.landingPageLinks.appUrlAndroidStatus == '1' || _config.landingPageLinks.appUrlIosStatus == '1') ? Text(
                  'download_our_apps'.tr, style: cairoBold.copyWith(color: _color, fontSize: Dimensions.fontSizeExtraLarge),
                ) : SizedBox(),
                ...
                && _config.socialMedia.length > 0)  GetBuilder<SplashController>(builder: (splashController) {
                  return Column(children: [
                    ...
                    Text(
                      'follow_us_on'.tr,
                      style: cairoBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall),
                    ),
              ...
              Expanded(flex: 2, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('my_account'.tr, style: cairoBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
              ...
              Expanded(flex: 2,child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('quick_links'.tr, style: cairoBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
          ...
          Text(
            _config.footerText ?? '',
            style: cairoRegular.copyWith(color: _color, fontSize: Dimensions.fontSizeExtraSmall),
          ),
          const SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: hovered ? cairoMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall)
            : cairoRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraSmall)),
      );
    });
  }
}
